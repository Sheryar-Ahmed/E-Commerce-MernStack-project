    ...
    <footer className="w-full bg-white dark:bg-gray-900 left-0 right-0 bottom-0">
      <div className="w-full p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {d.getFullYear()} <NavLink to="/" className="hover:underline">Ecommerce</NavLink>. All Rights Reserved.
          </span>
